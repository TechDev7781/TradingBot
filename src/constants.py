...
HTX_GET_MERGED_DETAIL_API_PATH: str = "/linear-swap-ex/market/detail/merged"
...
HTX_GET_MERGED_DETAIL_API_URL: str = HTX_BASE_API_URL + HTX_GET_MERGED_DETAIL_API_PATH
